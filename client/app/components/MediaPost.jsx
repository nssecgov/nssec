      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 py-20 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            There are currently no posts in the &quot;{categoryDisplayName}&quot; category. Please check back later for updates.
          </p>
          <Link
            href="/media"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28">
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4">
              ...
              Explore timely press releases, official announcements, insightful reports, and scholarly journals.
              </p>
            </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative w-full h-64 bg-gradient-to-br from-gray-100 to-gray-50">
                  ...
                  {/* Subcategory badge */}
                  {post.mainCategory === "news-headlines" && post.subCategory && (
                ...
                <div className="p-5 bg-white">
                  ...
                  {/* Description */}
                  {post.description && (
                    <p className="text-sm text-gray-600 line-clamp-3 leading-relaxed mb-4 line-clamp-3">
                      {post.description}
                    </p>
                  )}
